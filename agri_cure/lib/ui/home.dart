import 'package:agri_cure/ui/NavigationBar.dart';
...
class Home extends StatefulWidget {
  final int plantId;
  const Home({Key? key, required this.plantId}) : super(key: key);
        ...
        children: [
          Container(
            color: Color.fromARGB(
                255, 219, 219, 219), // Set the color for the entire Stack
          ),
          Positioned(
            top: 50,
            left: 20,
